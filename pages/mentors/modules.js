...
const arrowLeft = (
  <span>
    <Image width={"70%"} height={"70%"} src={sleft} />
  </span>
);
const arrowRight = (
  <span>
    <Image width={"70%"} height={"70%"} src={sright} />
  </span>
);
...
const SliderContent = [
  {
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku76939f6f09f84571b7457631ec93261e",
  },
  {
    src: M2,
    link: "https://workdrive.zohoexternal.com/external/5e86ac8a93dc4c4205dd2ce191085bff86b46bb41278a20739640c5496c52789",
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/pgvxh6019d732109740a18398c60ef332945a",
  },
  {
    src: M3,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/pgvxh99d78d1537964cd7bd8ae69cc3584c70",
  },
  {
    src: M4,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku5e068af3a9194b4e92cbd4f7554d72e2",
  },
  {
    src: M5,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9kub40e617113574be49c5c7195b283db98",
  },
  {
    src: M6,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku7e918a7dd55744b294c99f5d6bbdfa3f",
  },
  {
    src: M7,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku382774a5d1e944e49954ccedf7cf3401",
  },
  {
    src: M8,
  ...
  },
  {
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/pgvxhe3790b53d4d84885b84caaf2f8896937",
  },
  {
    src: ELIA,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku309377a3b042455cb4c0f73f1f5a18ac",
  },
  {
    src: ELIB,
    ...
    btSrc: watch1,
    linkVideo:
      "https://workdrive.zohoexternal.com/file/ls9ku425c49897fde4110b7d429b801bffb01",
  },
  {
    src: ELIC,
        ...
        <div className="main-content">
          <div className="content-wrapper">
            ...
            <h2 style={{ fontSize: "35px", fontWeight: "normal", color: "#A1AB23" }}>
              Happy Healthy & Wise sample modules
            </h2>

              <p>
                Each of the Following modules form part of a student’s Happy,
                Healthy & Wise outline. Remember, program length – counted in
                semesters - determines the number and sequence of modules. These
                are described in detail the Resources information. Click on the
                image to see the relevant module in more detail, or click the
                button below to watch an explainer video.
              </p>
              <div className="row">
                        ...
                        <Carousel.Item style={{ marginLeft: "25%" }}>
                          <div className="row">
                            ...
                            <div className="col-sm-12">
                              <a
                                style={{ width: "100%" }}
                                href={slides.linkVideo}
                                target="_blank"
                                rel="noreferrer noopener"
                              >
                                <Image
                                  width={slides.bWidth}
                                  height={slides.bHeight}
                                  src={watch1}
                                />
                              </a>
                            </div>
